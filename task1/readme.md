...
---
   В строках - подразделения банка, столбцы - бизнес-возможности второго уровня из 
Карта бизнес-возможностей (Business Capability Map).
![it_landscape_map.png](it_landscape_map.png)
2. Схему интеграции приложений с указанием участников процессов
---
   ![integration_schema.png](integration_schema.png)
---
3. Описание кредитного процесса (Процесс открытия кредита)   
...
---
3. Описание депозитного процесса (Процесс открытия депозита)
